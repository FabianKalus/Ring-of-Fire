...
@Input() cardAction = [
  { title: 'Rule', description: 'Make a rule. Everyone needs to drink when he / she breaks the rule.' },
  ...
  { title: 'Eight have a date', description: 'Choose someone an take a sip with him / her' },
  ...
  { title: 'Questionmaster', description: 'If anyone answer a question from the questionmaster, he / she drinks.' },
  { title: 'King´s cup', description: 'Fill an empty glas with a drink from table. The last king drink the glas' },
];
